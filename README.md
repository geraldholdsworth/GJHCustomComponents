...
<UL>
<LI>TRISCOSTickBox : RISC OS style tick box</LI>
<LI>TRISCOSRadioBox : RISC OS style radio (option) box</LI>
<LI>TRISCOSSlider : Coloured slider with title and value, or as a fader</LI>
<LI>TRISCOSButton : RISC OS style buttons</LI>
...
<H3 style="color:#FF00FF">TRISCOSTickBox and TRISCOSRadioBox</H3>
...
<H3 style="color:#FF00FF">TRISCOSSlider</H3>
<B style="color:#0000FF">Methods</B><br>
<B><I>Create(AOwner)</I></B><br>
Creates the control. Pass the owner control as the only parameter.<br><br>
<B style="color:#0000FF">Events</B><br>
...
<B><I>Faders</I></B>: Boolean<br>
The control is a fader, not a slider. Default: False.<br>
<B><I>FaderColour</I></B>: TFaderColour<br>
What colour to use as the fader control. Can be csRed, csGreen, csBlue, csYellow, csBlack, or csWhite. Default: csBlack<br>
<B><I>FaderGrads</I></B>: Boolean<br>
Show the markings on the fader. Default: True<br>
<B><I>FillSlider</I></B>: Boolean<br>
Whether to fill the slider or just to the position. Default: False.<br>
<B><I>GradColour</I></B>: TColor<br>
What colour to make the fader markings. Default: $000000<br>
...
<B><I>ValueDiv</I></B>: Integer<br>
When displaying the value, on a fader, what to divide the position by. Default: 1<br><br>
<H3 style="color:#FF00FF">TRISCOSButton</H3>
<B style="color:#0000FF">Methods</B><br>
<B><I>Create(AOwner)</I></B><br>
Creates the control. Pass the owner control as the only parameter.<br><br>
<B style="color:#0000FF">Events</B><br>
...
<B style="color:#0000FF">Properties</B><br>
In addtion to what is inherited from TCustomSpeedButton, including Top, Left, Visible, Parent, Name and Font.<br>
<B><I>Caption</I></B>: String<br>
